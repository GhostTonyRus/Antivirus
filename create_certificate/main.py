...
def create_self_signed_cert(name=None):
    ...
    CERT_FILE = os.path.join("certificates", name + "certificate.crt" if name else "certificate.crt")
    KEY_FILE = os.path.join("certificates", name + "privatKey.key" if name else "privatKey.key")
